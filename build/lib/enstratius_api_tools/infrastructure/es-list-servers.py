...
if __name__ == '__main__':
    ...
    if cmd_args.verbose:
        ...
        server_table = PrettyTable(["Region", "Server ID", "Provider ID", "Server Name", "Public IP",
                                    "Status", "Start Date"])
        for server in servers:
            server_table.add_row([server.region['name'], server.server_id, server.provider_id, server.name,
