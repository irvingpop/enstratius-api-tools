...
if __name__ == '__main__':
    ...
    if cmd_args.verbose:
        ...
        volume_table = PrettyTable(["Zone", "Volume ID", "Provider ID", "Volume Name", "Current Server",
                                    "Size", "Owner", "Status"])
        for volume in volumes:
            volume_table.add_row([volume.data_center['name'], volume.volume_id, volume.provider_id, volume.name,
